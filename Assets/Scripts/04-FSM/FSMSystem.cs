...
public abstract class FSMState : MonoBehaviour
{
    ...
    public FSMSystem fsmSystem { set{ fsm = value; } }
    protected ControlLayer ctrl;
    public ControlLayer controlLayer { set { ctrl = value; } }
...
public class FSMSystem
{
    ...
    /// <summary>
    /// This method is use to manually set current state for the FSM System.
    /// </summary>
    /// <param name="s"></param>
    public void SetCurrentState(FSMState s)
    {
        currentState = s;
        currentStateID = s.ID;
        //The first time initiation call this function
        s.DoBeforeEntering();
    }
    ...
    /// </summary>
    public void AddState(FSMState s, ControlLayer ctrl)
    {
